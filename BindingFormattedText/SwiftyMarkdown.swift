...
public struct BasicStyles : FontProperties {
    public var fontName : String? = NSFont.controlContentFontOfSize(24).fontName
...
public class SwiftyMarkdown {
    ...
    func attributedStringFromString(string : String, withStyle style : LineStyle, attributes : [String : AnyObject] = [:] ) -> NSMutableAttributedString {
...
//                textStyle = NSFontTextStyleTitle2
//            } else {
//                textStyle = NSFontTextStyleSubheadline
//            }
        ...
        case .H6:
            ...
            //textStyle = NSFontTextStyleFootnote
            attributes[NSForegroundColorAttributeName] = h6.color
        default:
            fontName = body.fontName
            //textStyle = NSFontTextStyleBody
        ...
        let styleSize = CGFloat(14)
        
        var finalFont : NSFont
        if let finalFontName = fontName, font = NSFont(name: finalFontName, size: styleSize) {
            finalFont = font
        } else {
            finalFont = NSFont.controlContentFontOfSize(14)
        }
 
        if style == .Italic {
            //Temp code
            finalFont = NSFont.boldSystemFontOfSize(styleSize)
        }
        if style == .Bold {
